...
class LongdogReport:
    ...
    def make_report_dir(self):
        ...
        # TODO: handle error if dir already exists
        shutil.copytree('./out/view/inc-longdog', self.report_path, dirs_exist_ok=True)
    ...
    def produce_report(self):
        ...
        with open(REPORT_TEMPLATE_PATH, 'r') as report_template:
            ...
            report_soup = bs4.BeautifulSoup(report_str_data, features='html.parser')
